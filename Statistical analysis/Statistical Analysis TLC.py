...
# Is there any relationship between payment type and fare amount?
...
# Descriptive statistics are essential because they provide a straightforward summary of data, making complex data sets understandable and accessible. They help in identifying patterns, trends, and potential outliers, giving an initial sense of what the data reveals without performing advanced analyses.
...
# This result suggests that there is a statistically significant difference between the means of the two groups in our data, with very strong evidence against the null hypothesis. The high t-statistic and extremely low p-value together indicates that riders who pay through credit cards pay a higher fare amount as compare to riders who pay by cash.
